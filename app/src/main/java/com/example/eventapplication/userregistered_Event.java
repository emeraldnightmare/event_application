...
public class userregistered_Event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                userregistered_Event.super.onBackPressed();
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adminalleventadapterclass adminalleventadapterclass = new adminalleventadapterclass(userregistered_Event.this,eventList);
