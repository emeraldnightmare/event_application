...
public class register_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //database reference to store user information
        reference = FirebaseDatabase.getInstance().getReference().child("UsersCreated");
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(register_activity.this, "Select The Account type", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void insertEventdata() {
        ...
        registerhelperclass user = new registerhelperclass(Fullname,Phonenumber,EmailID,Password);
